...
import 'package:marvel_test/src/views/Home/components/heroes_list_description.dart';
...
class HeroesListCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Get.bottomSheet(DetailView(heroSelected.id!), isScrollControlled: true),
      child: Card(
